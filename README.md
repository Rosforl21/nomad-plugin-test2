...
```sh
git clone https://github.com/Rosforl21/nomad-plugin-test2.git
cd nomad-plugin-test2
...
```sh
pip install dist/nomad-plugin-test2-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Rosario Forlenza | [omicron92@gmail.com](mailto:omicron92@gmail.com)
